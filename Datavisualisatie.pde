...
// draw 4 rectangle that representate the 4 difference age areas
void drawRegions() {
	fill(189,255,231);
...
// this is the for loop to draw the humans on a circle, the position of the circle is based on the ammount of relations
...
// draw human based on its coordinates assigned previously
...
// sort hashmap by its values in this case on age with our agecomperator
